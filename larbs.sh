...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/BlakePerkins/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/BlakePerkins/LARBS/master/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Luke + Blake's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
